...
with col2:
    ...
    st.markdown(f"<p style='text-align: center; color: {secondary_text};'>Nosso Meio Ambiente melhor e mais saudável, faça sua parte também</p>", unsafe_allow_html=True)
with col3:
